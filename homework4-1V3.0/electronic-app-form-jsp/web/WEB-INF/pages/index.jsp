...
<form class="my_form" name="my_form" id="my_form" method="get" action="/result.html">
    <div class="first size">
        1. Фамилия*: ${last_name}<br>
        <input type="text" name="last_name" id="last_name" value="${param.last_name}"/><br><br>
        2. Имя*: ${name}<br>
        <input type="text" name="name" id="name" value="${param.name}"/><br><br>
        3. Отчество:<br>
        <input type="text" name="middle_name" id="middle_name" value="${param.middle_name}"/><br><br>
        4. Секретная Фраза*: ${password}<br>
        <input type="password" name="password" id="password" value="${param.password}"/><br><br>
    </div>
    <div class="sex size">
        5. Возраст: ${age}<br>
        <input type="text" name="age" id="age" value="${param.age}"/><br><br>
        6. Пол*: ${sex}<br>
    ...
    <div class="other">
        ...
        <div class="other">
            ...
            <textarea name="other_text" id="other_text" rows="3" cols="30" ${paramValues.sources.stream().anyMatch(v->v == 'other').get() ? '' : 'disabled'}>${param.other_text}</textarea><br><br>
            13. Прочие Рекомендации:<br>
            <textarea name="recommendations" id="recommendations" rows="3"
                      cols="30">${param.recommendations}</textarea><br><br>
        </div>
    </div>
